...
const defaultMenu = {
'document':{'url':'https://chat.whatsapp.com/Chys4GZI70OJwRAeBt7nyx'},
  before: `
...
let handler = async (m, { conn, usedPrefix, __dirname }) => {
  try {
    ...
    let url = 'https://telegra.ph/file/9cad0e058587f6b538479.jpg'
    conn.sendButton(m.chat,
`𝚆𝚑𝚊𝚝𝚜𝙰𝚙𝚙 𝙰𝚜𝚒𝚜𝚝𝚎𝚗  | 𝙱𝚢 𝚂𝚑𝚞𝚗𝙺𝚊𝚝𝚣𝚞

${wish()} ${name}
`, text.trim(), `https://telegra.ph/file/9cad0e058587f6b538479.jpg`, [
      [`ꜱᴇᴡᴀʙᴏᴛ`, `${usedPrefix}sewa`],
      [`۪۪ᴏᴡɴᴇʀ`, `${usedPrefix}owner`]
    ], m, {asLocation: false})
  } catch (e) {
